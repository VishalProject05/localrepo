        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                ...
                <form method="post">
                    ...
                    <input type="text" name="txtfname" value="<?php if(isset($row[1])) echo $row[1]; ?>" class="form-control mb-3">
                    <label>Email ID</label>
                    <input type="email" value="<?php if(isset($row[2])) echo $row[2]; ?>" name="txtuemail" class="form-control mb-3">
                    <label>Mobile Number</label>
                    <input type="text" value="<?php if(isset($row[3])) echo $row[3]; ?>" name="txtno" class="form-control mb-3">
