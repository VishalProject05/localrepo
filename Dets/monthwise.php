    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                <form method="post">
                    <div class="mb-3">
                        <b><label>Start Month</label></b>
                        <input type="month" name="txtmonth1" class="form-control">
                    </div>
                    <div class="mb-3">
                        <b><label>End Month</label></b>
                        <input type="month" name="txtmonth2" class="form-control">
                    </div>
                ...
                <?php
                    if(isset($_POST['btnreg'])){
                        ...
                        $sdate = $_POST['txtmonth1']."-01";
                        $edate = $_POST['txtmonth2']."-31";
